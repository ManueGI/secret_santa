...
ActiveRecord::Schema[7.0].define(version: 2024_01_17_170602) do
  ...
  create_table "santa_assignements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["giver_id"], name: "index_santa_assignements_on_giver_id"
    t.index ["group_id"], name: "index_santa_assignements_on_group_id"
    t.index ["receiver_id"], name: "index_santa_assignements_on_receiver_id"
  end
